...
├── losses.py                    # 损失函数
├── models/
│   ├── segformer.py            # SegFormer-B1模型
│   └── baseline_models.py      # Baseline对比模型
├── utils/
│   ├── metrics.py              # 评估指标
│   └── visualize.py            # 可视化工具
├── train.py                    # 训练脚本
├── eval.py                     # 评估脚本
├── eval_baselines.py           # Baseline评估
├── Potsdam_processed/          # 训练数据
│   ├── images/                 # 2400张图像
│   └── labels/                 # 2400张标签
├── teacher_outputs/            # 教师特征
│   ├── features_30/            # Block 30特征
│   ├── features_31/            # Encoder输出
